        ...
        <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
            ...
            <div class="flex-1 flex flex-col overflow-y-auto overflow-x-hidden">
                ...
                @if(session()->has('impersonating_tenant_id'))
                    <div class="bg-blue-600 px-4 py-2 text-white text-center text-xs font-black uppercase tracking-widest flex flex-wrap justify-between items-center gap-2 shadow-lg sticky top-0 z-50">
                        ...
                        <form action="{{ route('admin.stop-impersonation') }}" method="POST">
                            @csrf
                            <button type="submit" class="bg-white text-blue-600 px-3 py-1 rounded-lg font-black hover:bg-blue-50 transition">
                ...
                <header class="bg-white border-b border-slate-100 sticky top-0 z-30">
                    <div class="px-6 py-4 flex items-center justify-between">
                        <div class="flex items-center">
                            <button @click="sidebarOpen = !sidebarOpen" class="text-slate-400 hover:text-blue-600 transition p-2 lg:hidden">
                            ...
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button class="flex items-center group transition">
                                        ...
                                        <div class="h-9 w-9 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                ...
                <footer class="mt-auto py-6 px-4 bg-gray-100 text-center text-xs text-gray-400">
                    ...
                    Desenvolvido por <span class="font-bold text-blue-500">LAVB Tecnologias</span>
                </footer>
            </div>
        </div>
    </body>
