        ...
        <a href="{{ route('dashboard') }}" class="flex items-center justify-center group">
            ...
            @else
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:rotate-6 transition-transform duration-500">
                        <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                    </div>
                    <div class="leading-none">
                        <span class="text-lg font-black text-white tracking-tighter uppercase block">COBRANÇA<span class="text-blue-400">PRO</span></span>
        ...
        @if(auth()->user()->tenant_id || session()->has('impersonating_tenant_id'))
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <x-sidebar-link :href="route('tenant.clientes')" :active="request()->routeIs('tenant.clientes*')" icon='<svg class="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>'>
                        Meus Clientes
                    </x-sidebar-link>
                    <x-sidebar-link :href="route('tenant.devedores')" :active="request()->routeIs('tenant.devedores*')" icon='<svg class="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>'>
                        Devedores
                    </x-sidebar-link>
            ...
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <x-sidebar-link :href="route('tenant.usuarios')" :active="request()->routeIs('tenant.usuarios*')" icon='<svg class="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>'>
                        Equipe
                    </x-sidebar-link>
                </nav>
            </div>
