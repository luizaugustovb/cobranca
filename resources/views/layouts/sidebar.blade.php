<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
            ...
            @else
                <div class="flex items-center space-x-3">
                    ...
                    <div class="leading-none">
                        <span class="text-lg font-black text-white tracking-tighter uppercase block">COBRANÃ‡A<span class="text-indigo-400">PRO</span></span>
    ...
    <div class="flex-grow overflow-y-auto px-4 py-6 space-y-8 custom-scrollbar">
        ...
        @if(auth()->user()->is_admin && !session()->has('impersonating_tenant_id'))
            <div>
                <p class="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4">AdministraÃ§Ã£o SaaS</p>
                <nav class="space-y-2">
        ...
        @if(auth()->user()->tenant_id || session()->has('impersonating_tenant_id'))
            <div>
                <p class="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4">OperaÃ§Ã£o</p>
                <nav class="space-y-2">
            ...
            <div>
                <p class="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4">EscritÃ³rio</p>
                <nav class="space-y-2">
