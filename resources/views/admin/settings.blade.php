<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col">
            ...
            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-2 px-1">GestÃ£o de Infraestrutura e Planos SaaS</p>
        </div>
    </x-slot>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <form action="{{ route('admin.settings.store') }}" method="POST">
                @csrf
                    ...
                    <!-- SeÃ§Ã£o: Pagamentos e Mensagens -->
                        ...
                        <div class="p-8 space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4 items-end">
                                ...
                                <div class="space-y-2 flex items-center space-x-3">
                                    <div class="flex-grow">
                                        <x-input-label for="test_phone" value="ðŸ“² Celular para Teste" class="text-[10px] font-black uppercase text-slate-400" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                                <div class="space-y-2">
                                    ...
                                    <p class="text-[9px] text-indigo-400 font-bold italic">Usado para gerenciar faturas automÃ¡ticas de todos os escritÃ³rios.</p>
                                </div>
                                <div class="space-y-2">
                ...
                <!-- Card 2: Matriz de Planos e MÃ³dulos -->
                <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                    <div class="p-8 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <h3 class="text-xs font-black text-slate-800 uppercase tracking-widest">ConfiguraÃ§Ã£o de Planos & MÃ³dulos Liberados</h3>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            <thead class="bg-slate-50/50">
                                <tr>
                                    <th class="px-8 py-4 text-[10px] font-black text-black uppercase tracking-widest border-b border-slate-100 italic">MÃ³dulos do Sistema</th>
                            ...
                            <tbody class="divide-y divide-slate-50 text-sm">
                                <tr class="bg-indigo-50/10">
                                    <td class="px-8 py-5 font-black text-indigo-600 uppercase text-[10px] tracking-tight">ðŸ’° Valor da Assinatura (Mensal)</td>
                                    <td class="px-8 py-5 text-center font-black text-slate-900 border-x border-slate-50">R$ {{ isset($plans['basic']) ? number_format($plans['basic']->valor, 2, ',', '.') : 'â€”' }}</td>
                                    <td class="px-8 py-5 text-center font-black text-slate-900 border-x border-slate-50">R$ {{ isset($plans['gold']) ? number_format($plans['gold']->valor, 2, ',', '.') : 'â€”' }}</td>
                                    <td class="px-8 py-5 text-center font-black text-slate-900 border-x border-slate-50">R$ {{ isset($plans['platinum']) ? number_format($plans['platinum']->valor, 2, ',', '.') : 'â€”' }}</td>
                                </tr>
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="px-8 py-5 font-bold text-slate-700 uppercase text-[10px] tracking-tight">ðŸ“² AutomaÃ§Ã£o WhatsApp (Disparos API)</td>
                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="px-8 py-5 font-bold text-slate-700 uppercase text-[10px] tracking-tight">ðŸ“¥ ImportaÃ§Ã£o Massiva (Lotes Excel)</td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" disabled class="rounded border-slate-200 text-slate-300 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" checked disabled class="rounded border-slate-200 text-indigo-600 focus:ring-indigo-500 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" checked disabled class="rounded border-slate-200 text-indigo-600 focus:ring-indigo-500 h-5 w-5"></td>
                                </tr>
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="px-8 py-5 font-bold text-slate-700 uppercase text-[10px] tracking-tight">ðŸ¤– Consultas de CPF Automatizadas (Bot)</td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" disabled class="rounded border-slate-200 text-slate-300 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" disabled class="rounded border-slate-200 text-slate-300 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" checked disabled class="rounded border-slate-200 text-indigo-600 focus:ring-indigo-500 h-5 w-5"></td>
                                </tr>
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="px-8 py-5 font-bold text-slate-700 uppercase text-[10px] tracking-tight">ðŸ“Š RelatÃ³rios de Performance AvanÃ§ados</td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" disabled class="rounded border-slate-200 text-slate-300 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" checked disabled class="rounded border-slate-200 text-indigo-600 focus:ring-indigo-500 h-5 w-5"></td>
                                    <td class="px-8 py-5 text-center"><input type="checkbox" checked disabled class="rounded border-slate-200 text-indigo-600 focus:ring-indigo-500 h-5 w-5"></td>
                                </tr>
                ...
                <div class="pt-8 flex justify-end">
                    <x-primary-button class="px-16 py-5 bg-indigo-600 hover:bg-slate-900 rounded-3xl shadow-2xl shadow-indigo-500/20 text-sm font-black uppercase tracking-[0.2em] transition">
                        Atualizar ConfiguraÃ§Ãµes Maestras
                    </x-primary-button>
                </div>
            </form>
