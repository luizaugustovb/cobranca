    ...
    <div class="py-6 sm:py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                <!-- Card 1 -->
                <div class="bg-white rounded-[2rem] p-6 sm:p-10 shadow-xl border border-slate-100 flex flex-col justify-between hover:shadow-2xl transition-all duration-500 group">
                    <div>
                        ...
                        <p class="text-2xl sm:text-4xl font-black text-slate-900 tracking-tighter">{{ $stats['total_tenants'] }}</p>
                    </div>
                ...
                <div class="bg-slate-900 rounded-[2rem] p-6 sm:p-10 shadow-2xl shadow-blue-900/20 flex flex-col justify-between relative overflow-hidden group">
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-blue-500/10 rounded-full group-hover:scale-110 transition-transform duration-700"></div>
                    <div>
                        <div class="w-12 h-12 bg-blue-600/20 rounded-2xl flex items-center justify-center text-blue-400 mb-6">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-8 pt-6 border-t border-slate-800 flex items-center text-[9px] font-black text-blue-400 uppercase tracking-widest">
            ...
            <div class="bg-white rounded-[2rem] shadow-2xl border border-slate-100 overflow-hidden">
                <div class="px-10 py-8 border-b border-slate-50 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 bg-slate-50/30">
                            ...
                            <tr class="hover:bg-slate-50/50 transition cursor-default">
                                <td class="px-10 py-6">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center font-black mr-6 uppercase shadow-sm text-xs">
                                ...
                                <td class="px-10 py-6 text-right">
                                    <span @class([ 'inline-block px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest' , 'bg-emerald-100 text-emerald-700'=> $t->status === 'active',
                                        'bg-amber-100 text-amber-700' => $t->status === 'inactive',
                                        'bg-red-100 text-red-700' => $t->status === 'suspended',
                                        ])>{{ ['active' => 'Ativo', 'inactive' => 'Inativo', 'suspended' => 'Suspenso'][$t->status] ?? $t->status }}</span>
