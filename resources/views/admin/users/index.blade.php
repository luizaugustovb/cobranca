                                ...
                                <tr class="hover:bg-slate-50/30 transition group">
                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex items-center justify-end space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <a href="{{ route('admin.users.edit', $admin->id) }}" class="p-2 bg-white text-blue-500 hover:bg-slate-50 rounded-xl shadow-sm border border-slate-100 transition" title="Editar">
