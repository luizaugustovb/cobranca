...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>CobranÃ§aPro - GestÃ£o Inteligente de RecuperaÃ§Ã£o Financeira</title>
        <!-- Fonts -->
    ...
    <body class="antialiased bg-slate-50 text-slate-900 selection:bg-blue-600 selection:text-white">
        ...
        <nav class="fixed top-0 w-full z-50 bg-glass border-b border-slate-200/50">
            <div class="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-black tracking-tighter uppercase leading-none">COBRANÃ‡A<span class="text-blue-600">PRO</span></span>
                </div>
                <div class="hidden md:flex items-center space-x-8 text-xs font-black uppercase tracking-widest text-slate-500">
                    ...
                    <a href="#solucoes" class="hover:text-blue-600 transition">SoluÃ§Ãµes</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="px-6 py-3 bg-blue-600 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-700 transition shadow-xl shadow-blue-500/20">Solicitar DemonstraÃ§Ã£o</a>
                    @endauth
                </div>
            </div>
        </nav>
        ...
        <section class="pt-48 pb-32 px-6 relative overflow-hidden bg-white">
            ...
            <div class="max-w-5xl mx-auto text-center relative z-10">
                <span class="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest mb-6 border border-blue-100 shadow-sm animate-bounce">A Nova Era da RecuperaÃ§Ã£o Financeira</span>
                <h1 class="text-6xl md:text-8xl font-black text-slate-900 tracking-tighter mb-8 leading-[0.9] uppercase italic transform -skew-x-2">Recupere capital com <span class="text-blue-600 italic">inteligÃªncia artificial.</span></h1>
                <p class="text-xl text-slate-400 font-medium max-w-2xl mx-auto mb-12">Plataforma multi-tenant de alta performance para escritÃ³rios de cobranÃ§a, assessorias jurÃ­dicas e empresas de fomento mercantil.</p>
                <div class="flex flex-col md:flex-row items-center justify-center gap-4">
                    <a href="{{ route('register') }}" class="w-full md:w-auto px-10 py-5 bg-blue-600 text-white rounded-3xl font-black uppercase text-sm tracking-widest hover:bg-blue-700 transition-all hover:scale-105 shadow-2xl shadow-blue-500/30">ComeÃ§ar Agora GrÃ¡tis</a>
                    <a href="#" class="w-full md:w-auto px-10 py-5 bg-slate-100 text-slate-800 rounded-3xl font-black uppercase text-sm tracking-widest hover:bg-slate-200 transition-all border border-slate-200">Ver VÃ­deo Demo</a>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    <div class="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition duration-500 transform hover:-translate-y-4">
                        ...
                        <h3 class="text-2xl font-black tracking-tighter uppercase mb-4">NegociaÃ§Ã£o Digital</h3>
                        <p class="text-slate-400 font-medium">Calculadora avanÃ§ada de juros, multas e parcelamento automÃ¡tico com geraÃ§Ã£o de acordos em segundos.</p>
                    </div>
                    <div class="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition duration-500 transform hover:-translate-y-4">
                        ...
                        <p class="text-slate-400 font-medium">NotificaÃ§Ãµes automÃ¡ticas via WhatsApp e E-mail para aumentar em atÃ© 40% a taxa de recebimento dos devedores.</p>
                    </div>
                    <div class="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition duration-500 transform hover:-translate-y-4">
                        ...
                        <p class="text-slate-400 font-medium">IntegraÃ§Ã£o nativa com Asaas e Viicio para baixas automÃ¡ticas em tempo real direto na conta corrente.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="py-12 bg-slate-900 text-white text-center">
            <p class="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">&copy; {{ date('Y') }} COBRANÃ‡APRO â€¢ SAAS MULTITENANT PREMIUM</p>
        </footer>
