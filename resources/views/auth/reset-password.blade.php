<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
        ...
        <div class="space-y-2">
            ...
            <x-text-input id="email" class="w-full bg-slate-50 border-slate-100 rounded-2xl py-4 focus:ring-indigo-500 focus:border-indigo-500 transition shadow-sm" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
