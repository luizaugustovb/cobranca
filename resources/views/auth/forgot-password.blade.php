<x-guest-layout>
    <div class="mb-10 text-center">
        ...
        <p class="text-xs text-slate-400 font-bold uppercase tracking-widest mt-2 px-6">Informe seu CPF e Celular para receber uma nova senha temporÃ¡ria via WhatsApp.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.whatsapp') }}" class="space-y-6">
        ...
        <!-- Phone / WhatsApp -->
        <div class="space-y-2">
            <x-input-label for="phone" :value="__('WhatsApp (DDI+DDD+NÃšMERO)')" class="text-[10px] font-black uppercase tracking-widest text-slate-400" />
