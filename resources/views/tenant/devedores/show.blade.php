        ...
        <div class="flex justify-between items-start">
            ...
            <div class="flex space-x-3">
                ...
                <a href="https://wa.me/{{ $telWaDevedor }}?text={{ $msgCobranca }}" target="_blank"
                    class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-xl font-bold text-sm uppercase transition hover:bg-green-600 shadow-lg shadow-green-500/20">
