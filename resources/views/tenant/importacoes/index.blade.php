<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <a href="{{ route('tenant.importacoes.activesoft') }}" class="inline-flex items-center justify-center px-5 py-3 bg-red-600 border border-transparent rounded-xl font-bold text-white uppercase tracking-widest hover:bg-red-700 transition shadow-xl text-sm ml-2">
                                ...
                                <tr class="hover:bg-gray-50/50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <a href="{{ route('tenant.importacoes.show', $import) }}" class="p-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-500 hover:text-white transition">
